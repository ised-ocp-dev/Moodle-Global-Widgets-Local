 ...
 * @return bool result
 */
function xmldb_local_globalwidgets_upgrade($oldversion) {
    global $DB, $USER, $SITE;
    ...
    if ($result && $oldversion < 2019000007) {
        if (!$dbman->table_exists('globalwidgets_logs')) {
            $dbman->install_one_table_from_xmldb_file(__DIR__.'/install.xml', 'globalwidgets_logs');
        }
    ...
    if ($oldversion < 2019000008) {
        ...
        $dbman = $DB->get_manager();
        $table = new xmldb_table('globalwidgets_logs');
    ...
    if ($oldversion < 2019000021) {
        ...
        // globalwidgets savepoint reached.
        upgrade_plugin_savepoint(true, 2019000021, 'local', 'globalwidgets');
    ...
    if ($oldversion < 2019000029) {
        ...
        $table = new xmldb_table('globalwidgets_datacache');
